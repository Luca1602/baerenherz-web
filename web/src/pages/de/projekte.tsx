...
export default function ProjekteDE() {
  return (
    <div>
      ...
      <div className="container-body">
        ...
        <section id="projekte2026" className="mb-12 py-6">

          <h2 className="text-2xl font-bold text-blue-900 mb-6">Projekte 2026</h2>

          <h3 className="text-xl font-bold text-blue-900 mb-2">Projekt Tabaluga – Gemeinsam für Kinder in Not</h3>

          <p className="text-gray-800 leading-relaxed mb-3">
            Bärenherz e.V. unterstützt im Jahr 2026 die Tabaluga Kinderstiftung – in Zusammenarbeit mit der Michael Roll Stiftung.
          </p>

          <h4 className="font-bold text-blue-900 mb-1">Die Tabaluga Kinderstiftung</h4>

          <p className="text-gray-800 leading-relaxed mb-1">
            Die Tabaluga Kinderstiftung setzt sich seit 1998 für sozial benachteiligte, traumatisierte und schwer erkrankte Kinder und Jugendliche ein. Jährlich werden rund 500 junge Menschen individuell betreut, davon leben zwischen 80 und 90 Kinder und Jugendliche langfristig in den Tabaluga Kinderhäusern in Tutzing, Schongau und Peißenberg.
          </p>

          <p className="text-gray-800 leading-relaxed mb-1">
            Heranwachsende junge Menschen werden im teilbetreuen und betreuten Wohnen auf dem Weg in die Selbständigkeit begleitet.
          </p>

          <p className="text-gray-800 leading-relaxed mb-1">
            Die pädagogische Arbeit verbindet einen heilpädagogisch-therapeutischen mit einem traumapädagogischen Ansatz. Ein geregelter, beschützender Alltag bildet die Grundlage – ergänzt durch ein breites Spektrum individueller Therapieangebote: Heilpädagogisches Reiten, Musik- und Kunsttherapie, Tanztherapie, Gesprächstherapie sowie Erlebnispädagogik. Im Therapie- und Kreativzentrum ORANGE HOUSE gewinnen die Kinder unter dem Motto „Ich schaff was!“ wieder Vertrauen in ihre eigenen Fähigkeiten und entdecken neue Lebensperspektiven.
          </p>

          <p className="text-gray-800 leading-relaxed mb-3">
            Das Ziel: gemeinsam mit den Kindern tragfähige Lebenskonzepte entwickeln und ihnen eine Perspektive für eine glückliche Zukunft geben.
          </p>

          <h4 className="font-bold text-blue-900 mb-1">Die Michael Roll Stiftung</h4>

          <p className="text-gray-800 leading-relaxed mb-3">
            Die Michael Roll Stiftung fördert seit 2011 gezielt die therapeutische Arbeit der Tabaluga Kinderstiftung. Mit einem besonderen Fokus auf Reit- und Musiktherapie sorgt sie dafür, dass diese wichtigen Einstiegstherapien für traumatisierte Kinder eine gesicherte Zukunft haben.
          </p>

          <h4 className="font-bold text-blue-900 mb-1">Unser Engagement</h4>

          <p className="text-gray-800 leading-relaxed mb-1">
            Bärenherz e.V. ist stolz darauf, diese wertvolle Arbeit gemeinsam mit der Michael Roll Stiftung zu unterstützen. Jedes Kind verdient Schutz, Zuwendung und die Chance auf ein selbstbestimmtes Leben. Sämtliche Einnahmen aus unseren Veranstaltungen fließen direkt in dieses Projekt – so stellen wir sicher, dass jeder Beitrag dort ankommt, wo er am meisten gebraucht wird.
          </p>
